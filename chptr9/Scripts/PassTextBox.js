...
AjaxEnabled.PassTextBox.prototype = {
    ...
    _onKeyup: function (e) {
        ...
        switch (strength) {
            case "Weak": this.get_element().className = this._weakCssClass;
                break;
            case "Medium": this.get_element().className = this._mediumCssClass;
                break;
            case "Strong": this.get_element().className = this._strongCssClass;
                break;
        }
    },
    //define property
